  ...
  return (
    <div className="p-6 md:p-10 max-w-[900px]" data-testid="knowledge-page">
      ...
      <form onSubmit={add} className="flex flex-col sm:flex-row gap-2 mb-8 max-w-xl">
        ...
        <input id="knowledge-add" value={name} onChange={(e) => setName(e.target.value)} placeholder="Add a knowledge source (demo, stored locally)..." className="flex-1 bg-black border border-white/20 px-4 py-2.5 text-[13px] text-white placeholder:text-white/35 focus:border-[#ff4d0a] focus:outline-none" data-testid="knowledge-add-input" />
